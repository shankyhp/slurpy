...
export default function Scene({}: Props) {
  ...
  useGSAP(() => {
    ...
    /* I can change the position of can for future h1 h2 updates */
    /* +z can comes towards us -z goes away from us */
  ...
  return (
    <group ref={groupRef}>
      ...
      {/* <OrbitControls /> */}{" "}
      {/* this allows us to move the 3d obbject and check its position  */}
